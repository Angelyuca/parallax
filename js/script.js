$(document).ready(function () {
    $(window).scroll(function (event) {
        ...
        $('.parallax-montain-1').css('transform', 'scale('+z_2+')');

        var hr=w/2000*p_b;
        var z_3=1+(w*0.000005*p_b);
        $('.parallax-montain-2').css('transform', 'translate3d('+hr+'px,0,0) scale('+z_3+')');

        var hr_2=w/1500*p_b;
        var z_4=1+(w*0.00001*p_b);
        $('.parallax-montain-3').css('transform', 'translate3d('+hr_2+'px,0,0) scale('+z_4+')');
